module.exports = {
    ...
    tasks: [
        //0 - часть 1...
        "*Привет! Добро пожаловать в ДИТ challenge!*\n\nЗдесь тебе предстоит продемонстрировать свою смекалку и эрудицию, решив разнообразные логические и математические задачи.\n\n В следующие 2 недели каждый день ты будешь решать по 1 задаче, но в финальные 3 дня, когда победа кажется уже так близко, будет 2 задачи. На каждую задачу тебе необходимо дать верный ответ. За отсутствие ответа или неверный ответ штрафные баллы не предусматриваются.\n\n*Количество попыток для ввода правильного ответа ограничено до 3.*\n\nЕсли задача решена не с первой попытки, количество баллов будет меньше. Если решить задачу за 3 попытки не получилось, переходишь к следующему заданию.\n\nЗадачи открываются в 12:00 GMT+3. Решать задачи можно только последовательно, подключиться можно в любой момент!",
        ...
        //Часть 2...
        "*Финал уже близко!*\n\nС сегодняшнего дня тебе предстоит решать по 2 задачи в день!",
        //12 = 16 (-4)
        ...
        //18
        "Ура! ДИТ challenge завершена! Отличная работа. Рейтинг участников будет опубликован вместе с именами победителей 9 марта. Ну, и, конечно, разыграем утешительный мерч!"
    ],
    conds: [
        ...
        {answer: ["!уровень"], time: 3, tryouts: 0, points: 0},
        //25 special (includes)
        {answer: ["!сначалапрямо", "!потомналево", "!постучатьтрираза", "!ивойти"], time: 7, tryouts: 8, points: 25},
        {answer: ["!уровень"], time: 3, tryouts: 0, points: 0},
        //27 special (includes)
