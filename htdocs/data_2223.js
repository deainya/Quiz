module.exports = {
    ...
    tasks: [
        ...
        //29
        "Ты слышишь какие-то странные звуки? Кажется, начался обратный отсчёт! Это аппарат телепортации! Смотри, нужно скорее ввести нужные координаты, чтобы нас не перенесло в какой-нибудь океан.\nОтветь на 9 вопросов и получи нужные координаты. Поторопись, на каждый вопрос у тебя есть только *20 секунд*.\nКак только будете готовы, введите слово «поехали» с восклицательным знаком вначале, вот так:\n\n*!поехали*",
        //30
        ...
        //39
        "Вот это скорость! Просто класс! Мы успели ввести координаты -25.0752415, -130.0887543 в машину телепортации!\nКак только будете готовы, введите слово «телепортация с восклицательным знаком вначале, вот так:\n*!телепортация*",
        //40
        "Это шум моря? Где мы? Похоже на какой-то остров. Неужели Гринч затащил сюда наших котеек?! Хоть бы здесь был кто-нибудь ещё... \nДавай поищем людей на острове? Когда найдёшь, напиши, какого цвета рубашка у одного из мужчин.\n\nФормат ответа:\n\n*!слово (БЕЗ пробелов)*",
        //41
        "Ура! Мы тут не одни. И как хорошо, что ты поинтересовался у фотографов, не видели ли они наших любимцев. Оказывается, совсем недавно Гринч пробегал прямо мимо них, в том направлении! Побежали за ним скорее!\nИди по дороге, пока не встретишь на своём пути препятствие. Какое количество транспортных средств перед тобой?\n\nФормат ответа:\n\n*!слово (БЕЗ пробелов)*",
        //42
        "Ура! Мы нашли Гринча! Только вот он совсем не горит желанием вернуть нам Тима и Фичу... Может быть, с ним можно как-то договориться? Хорошо, что этот зелёный злодей азартный и любит поиграть! Он предложил нам разгадать ребусы. Помоги вернуть наших котов, разгадав ребусы Гринча.\nКак только будете готовы, введите слово «вперёд» с восклицательным знаком вначале, вот так:\n\n*!вперёд*",
        //43
        "Гринч предлагает тебе отгадать фильмы, что изображены на минималистичных постерах.\nКак только будете готовы, введите слово «вперёд» с восклицательным знаком вначале, вот так:\n\n*!вперёд*",
        //44
    ...
    conds: [
        ...
        {answer: ["!9:15"], time: 0, tryouts: 1, points: 10}, //33
        ...
        {answer: ["филиппкиркоров"], time: 0, tryouts: 0, points: 0} //62
